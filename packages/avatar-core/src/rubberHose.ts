...
export const canLocalOverlays = (spray = DEFAULT_CAN_SPRAY): OverlayLayer[] => {
  const overlays: OverlayLayer[] = [
    ...
    layer(hose(-40, 10, -58, 18, -52, 34, 6.4), 'ink', 'back'),
    layer(glove(-54, 38, 1.05, false), 'paper', 'back'),
    ...
    layer(hose(40, 6, 58, 0, 74, -4, 6.2), 'ink', 'front'),
    layer(glove(82, -4, 1.08, true), 'paper', 'front'),
