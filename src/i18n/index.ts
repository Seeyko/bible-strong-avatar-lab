...
const english: Record<string, string> = {
  ...
  'Anneaux graffiti': 'Graffiti rings',
  'Anneau épais': 'Thick ring',
  'Anneau brossé': 'Brushed ring',
  'Anneau uniforme gauche': 'Left uniform ring',
  'Anneau du milieu': 'Middle ring',
  'Anneau uniforme droit': 'Right uniform ring',
  'Aplats graffiti': 'Graffiti blobs',
  'Les 16 aplats de droite de la planche Thomas. Un aplat différent change l’expression.':
    'The 16 right-hand blobs from Thomas’s sheet. A different blob changes the expression.',
  'Tokens de couleur': 'Color tokens',
  Spot: 'Spot',
  Session: 'Session',
  Event: 'Event',
  Shop: 'Shop',
  'Aplat long gauche': 'Long left blob',
  'Aplat long droit': 'Long right blob',
  'Aplat vertical': 'Vertical blob',
  'Aplat compact': 'Compact blob',
  'Aplat ovale': 'Oval blob',
  'Aplat hyped': 'Hyped blob',
  'Aplat idle droit': 'Idle right blob',
  'Aplat idle': 'Idle blob',
  'Aplat clin': 'Wink blob',
  'Aplat oops': 'Oops blob',
  'Aplat fin': 'Thin blob',
  'Aplat squint': 'Squint blob',
  'Aplat trait': 'Stroke blob',
  'Aplat smear': 'Smear blob',
  'Aplat large': 'Wide blob',
  'Aplat splash': 'Splash blob',
