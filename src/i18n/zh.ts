export const chinese: Record<string, string> = {
  ...
  Cône: '圆锥体',
  Diamant: '菱形体',
  'Bombe rubber-hose': '橡胶管喷漆罐',
  'Puff de spray': '喷雾云',
  'Membres rubber-hose': '橡胶软管四肢',
  'Bras hanche': '叉腰手臂',
  'Bras qui pointe': '指向手臂',
  'Jambe arrière': '后腿',
  'Jambe avant': '前腿',
  ...
  'Anneaux graffiti': '涂鸦圆环',
  'Anneau épais': '粗圆环',
  'Anneau brossé': '笔刷圆环',
  'Anneau uniforme gauche': '左侧均匀圆环',
  'Anneau du milieu': '中间圆环',
  'Anneau uniforme droit': '右侧均匀圆环',
  'Aplats graffiti': '涂鸦色块',
  'Les 16 aplats de droite de la planche Thomas. Un aplat différent change l’expression.':
    '托马斯图板右侧的 16 个色块。不同色块对应不同表情。',
  'Tokens de couleur': '颜色标记',
  Spot: 'Spot',
  Session: 'Session',
  Event: 'Event',
  Shop: 'Shop',
  'Aplat long gauche': '左侧长色块',
  'Aplat long droit': '右侧长色块',
  'Aplat vertical': '竖向色块',
  'Aplat compact': '紧凑色块',
  'Aplat ovale': '椭圆色块',
  'Aplat hyped': '兴奋色块',
  'Aplat idle droit': '右侧待机色块',
  'Aplat idle': '待机色块',
  'Aplat clin': '眨眼色块',
  'Aplat oops': 'Oops 色块',
  'Aplat fin': '细色块',
